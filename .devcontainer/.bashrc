...
alias frontend="cd /workspaces/Brewery/WebApp && ng serve --host 0.0.0.0 --configuration development --verbose"
alias build-backend="cd /workspaces/Brewery/Server && dotnet build --configuration Debug"
alias build-frontend="cd /workspaces/Brewery/WebApp && ng build --configuration development"
...
echo "  frontend         - Run Angular dev server (development mode with source maps)"
echo "  build-backend    - Build .NET solution (debug configuration)"
echo "  build-frontend   - Build Angular app (development mode with source maps)"
